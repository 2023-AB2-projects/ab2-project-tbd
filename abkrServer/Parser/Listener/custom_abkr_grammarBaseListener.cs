...
namespace abkrServer.Parser.Listener
{
    ...
    {
        public override void EnterStatement(abkr_grammar.StatementContext context)
        {
            Console.WriteLine("Entering statement");
            base.EnterStatement(context);
        }

        public override void ExitStatement(abkr_grammar.StatementContext context)
        {
        ...
        public override void ExitCreate_database_statement(abkr_grammar.Create_database_statementContext context)
        {
        ...
        public override void ExitCreate_table_statement(abkr_grammar.Create_table_statementContext context)
        {
        ...
        public override void ExitColumn_definition(abkr_grammar.Column_definitionContext context)
        {
